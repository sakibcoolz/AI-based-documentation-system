# Static Repository Intelligence / task-004 — Git & Dependency Intelligence

## Objective
Collect git metadata and dependency insights without executing repository code.

## Why This Task Exists
This task delivers a required MVP capability for static repository intelligence and provides inputs needed by downstream phases.
