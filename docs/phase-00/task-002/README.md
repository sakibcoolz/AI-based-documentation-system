# Foundation / task-002 — Domain & Persistence Contracts

## Objective
Define repository, scan, finding, evidence, and artifact contracts plus persistence boundaries.

## Why This Task Exists
This task delivers a required MVP capability for foundation and provides inputs needed by downstream phases.
